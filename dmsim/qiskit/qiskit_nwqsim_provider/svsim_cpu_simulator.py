...
"""Backend for the SV-Sim CPU simulation environment."""
...
import qiskit_nwqsim_provider.libsvsim as svsim
...
class SVSimWrapper:
    """Converter to and from SVSim_cpu simulator"""
    ...
    def __init__(self, qobj, shell):
        ...
        self.sim = svsim.Simulation(self.n_qubits, shell.n_cpus)
...
#======================================== SVSim Simulator ================================
class SVSimCpuSimulator(BaseBackend):
    """Python interface to NWQSim's SVSim cpu simulator"""
    MAX_QUBITS_MEMORY = int(log2(local_hardware_info()['memory']*(1024**3)/16))
    DEFAULT_CONFIGURATION = {
        'backend_name': 'svsim',
        'backend_version': VERSION,
        'n_qubits': min(32,MAX_QUBITS_MEMORY),
        'url': 'https://github.com/pnnl/svsim',
        'simulator': True,
        'local': True,
        'conditional': True,
        'open_pulse': False,
        ...
        'max_shots': 65536,
        'coupling_map': None,
        'description': 'NWQSim density matrix simulator with a single-CPU',
        'basis_gates': ['x', 'y', 'z', 'h', 's', 'sdg', 't', 'tdg', 'ri', 'rx', 'ry', 'rz', 
            'sx', 'p', 'u', 'cx', 'cy', 'cz', 'ch', 'cs', 'csdg', 'ct', 'ctdg', 'cri', 
